...
//
		...
		System.out.println("///  P13) 2.1.3 Geklickte Karte finden und ihre Reaktion testen");
		GrafikKonsole.clearGrafik();
        Spielfeld _spielfeld = new Spielfeld(4,4);
        _spielfeld.zufaelligeKartenFuellen();
        _spielfeld.spielFeldAusgeben();
        Button endeButton = new Button(200, 190,Grafik.RED, "ENDE", Grafik.BLACK, "ENDE");
		String eingabe;
        Karte gefundeneKarte;
        ...
        while(weitermachen){
            ...
            if(eingabe.equals("ENDE")){
                ...
                gefundeneKarte=_spielfeld.findeKarte(eingabe);
                if(gefundeneKarte != null){
                    gefundeneKarte.klickReaktion();
                    //gefundeneKarte.keineRedefintion();
                    //kompiler fängt in der Klasse Karte zu suchen
                }
               else{
                   weitermachen=false;
               }
