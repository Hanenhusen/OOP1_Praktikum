...
class Karte {
    ...
    void aendereAussehen( String _farbe){
        String [] auswahlFarben = {Grafik.WHITE, Grafik.BLACK, Grafik.GREY, Grafik.RED, Grafik.BLUE, Grafik.GREEN, Grafik.YELLOW, Grafik.MAGENTA,Grafik.CYAN};
	...
	void uebernehmeAussehen(Karte _k){
        this.aendereAussehen(_k.farbe,_k.text);
    }
    ...
    String farbeAendern(){
        ...
        this.meinButton.setFillcolor(erlaubteFarben[zufallsZahl(7)]);
