...
Method s = null;
try {
s = _1_Referenz_Datentypen.class.getMethod("main", String[].class); 
} catch(Exception findMainException) {
System.err.println("Error: Main method not found in class _1_Referenz_Datentypen, please define the main method as:");
