...
Method s = null;
try {
s = _1_Variable_und_Datentypen.class.getMethod("main", String[].class); 
} catch(Exception findMainException) {
System.err.println("Error: Main method not found in class _1_Variable_und_Datentypen, please define the main method as:");
