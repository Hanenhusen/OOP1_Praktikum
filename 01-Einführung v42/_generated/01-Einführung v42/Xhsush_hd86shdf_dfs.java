...
Method s = null;
try {
s = _4_Codieren_in_5Code.class.getMethod("main", String[].class); 
} catch(Exception findMainException) {
System.err.println("Error: Main method not found in class _4_Codieren_in_5Code, please define the main method as:");
